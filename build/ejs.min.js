  ...
  })()(
    {
      1: [
        function(require, module, exports) {
          ...
          const _OPTS_EXPRESS = _OPTS.concat('cache');
          const _BOM = /^\uFEFF/;
          ...
          function includeSource(path, options) {
            ...
            return { source: templ.source, filename: includePath, template };
          }
          ...
          Template.prototype = {
            ...
            compile() {
              ...
              const returnedFn = function(data) {
              ...
              if (matches && matches.length) {
                matches.forEach((line, index) => {
                  ...
                  if ((include = line.match(/^\s*include\s+(\S+)/))) {
                    ...
                    if (
                      opening &&
                      (opening == `<${d}` || opening == `<${d}-` || opening == `<${d}_`)
                    ) {
          ...
          if (require.extensions) {
            require.extensions['.ejs'] = function(module, flnm) {
              ...
              const options = { filename, client: true };
              const template = fileLoader(filename).toString();
              const fn = exports.compile(template, options);
